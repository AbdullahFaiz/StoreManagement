...
export default function ProductForm({ formAction, initialData, errors }: ProductFormProps) {
    const [formErrors, setFormErrors] = useState<ProductFormProps['errors']>(errors || {});
    ...
    return (
        <div className="w-full">
            ...
            <div>
                ...
                className="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-base p-3"
                />
                {formErrors?.name && (
            ...
            <div>
                ...
                className="mt-2 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-base h-32 p-3"
                ></textarea>
            ...
            <div className="flex justify-end mt-6">
                ...
                <a 
                href="/" 
                className="text-blue-600 hover:text-blue-800 underline ml-4 py-3"
                >
                Cancel
                </a>
            </div>
